...
// Usa 'require' em vez de 'import' para sintaxe CommonJS, o padrão do Node.js
...
const app = express();
// Certifique-se de inicializar o Ollama com a URL correta se não for localhost:11434
...
app.get('/', (req, res) => {
    // Como já usamos express.static('public'), a linha abaixo é mais uma garantia.
